...
export default {
  ...
  'login.form.username.hint': "输入用户名",
  'login.form.password.hint': "输入密码",
  'login.form.username.label': "用户名",
  'login.form.password.label': "密码",
  'login.form.password.validate.required': "密码不能为空",
  'login.form.username.validate.required': "用户名不能为空",
  'login.form.login.btn': "登录",
  'login.form.login.account': "账户密码登录",
  ...globalHeader,
  ...menu,
  ...settingDrawer,
  ...settings,
