    ...
    <div>
      <Card className={styles.main}>
        <div className={styles.infoCardHeader}>
          {activeEditMode ?
            <div>
              <Button type="primary" onClick={onSubmitClick}>应用</Button>
      ...
      <div className={styles.uploadBtnWrap}>
        <UploadCoverButton targetURL={`${ApplicationConfig.apiURL}/book/${book?.id}/cover`}/>
      </div>
      </Card>
    </div>
  );
...
export default connect(({bookDetail,bookDetailInfo}: ConnectState) => ({bookDetail,bookDetailInfo}))(BookDetailInfo)
