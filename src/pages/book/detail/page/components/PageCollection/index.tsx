...
export default function PageCollection({pages = [], onDelete, onSetCover, onSetOrderActionClick}: PageCollectionPropsType) {
  const items = pages?.map((page: Page) => {
    return (
      <Col key={page.id} className={styles.col}>
        <PageCard page={page} onDelete={onDelete} onSetCover={onSetCover}
